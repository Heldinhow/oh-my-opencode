...
export const LIBRARIAN_PROMPT_METADATA: AgentPromptMetadata = {
  ...
  cost: "CHEAP",
  promptAlias: "Keeper",
  keyTrigger: "External library/source mentioned -> fire keeper background",
  triggers: [
...
export function createKeeperAgent(model: string): AgentConfig {
