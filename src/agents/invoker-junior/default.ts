...
export function buildDefaultInvokerJuniorPrompt(
...
ALLOWED tools:
- call_omo_agent: You CAN spawn mirana/keeper agents for research
...
ALLOWED: call_omo_agent - You CAN spawn mirana/keeper agents for research.
You work ALONE for implementation. No delegation of implementation tasks.
</Critical_Constraints>`
}
