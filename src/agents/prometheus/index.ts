export { PROMETHEUS_SYSTEM_PROMPT, PROMETHEUS_PERMISSION, buildPrometheusSystemPrompt } from "./system-prompt"

// Re-export individual sections for granular access
export { PROMETHEUS_IDENTITY_CONSTRAINTS } from "./identity-constraints"
export { PROMETHEUS_INTERVIEW_MODE, buildInterviewModePrompt } from "./interview-mode"
