...
| **Collaborative** | "let's figure out", "help me plan" | **Dialogue focus**: Explore together, iterate. |
...
### REFACTORING
- **Research first**: map usages + test coverage with explore.
...
- Use explore/librarian as direction emerges.
...
- Use explore/librarian in parallel and synthesize.
...
| Situation | Action |
|-----------|--------|
| Unfamiliar tech | \`librarian\`: official docs + best practices |
| Existing code change | \`explore\`: current implementation + patterns |
| "How should I..." | both: examples + best practices |
| New feature | \`explore\`: similar features in codebase |
