...
task(subagent_type="explore", load_skills=[], description="Mirana project structure", run_in_background=true, prompt="Project structure: PREDICT standard patterns for detected language → REPORT deviations only")
...
task(subagent_type="explore", load_skills=[], description="Mirana build/CI", run_in_background=true, prompt="Build/CI: FIND .github/workflows, Makefile → REPORT non-standard patterns")
...
task(subagent_type="explore", load_skills=[], description="Mirana deep modules", run_in_background=true, prompt="Deep modules at depth 4+: FIND hidden patterns, internal conventions")
