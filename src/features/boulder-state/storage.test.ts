...
describe("boulder-state", () => {
  ...
  const SISYPHUS_DIR = join(TEST_DIR, ".specify")
  ...
  describe("writeBoulderState", () => {
    test("should write state and create .invoker directory if needed", () => {
...
`)
  ...
  describe("getPlanName", () => {
    test("should extract plan name from path", () => {
      // given
      const path = "/home/user/.specify/plans/project/my-feature.md"
      // when
