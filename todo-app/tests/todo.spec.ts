// This test file gracefully degrades when Playwright is not installed.
// Provide a TS ambient declaration to avoid type-check errors when the module
// is not installed in the environment.
declare module '@playwright/test';
// It attempts to load Playwright dynamically and only registers tests when available.
(async () => {
  try {
    ...
    // Playwright not installed; skip tests gracefully
  }
})();
